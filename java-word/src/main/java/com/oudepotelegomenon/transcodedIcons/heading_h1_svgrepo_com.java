 ...
 */
public class heading_h1_svgrepo_com implements RadianceIcon {
...
generalPath.moveTo(17.57f, 7.0f);
generalPath.curveTo(16.976f, 7.95f, 16.066f, 8.658f, 15.0f, 9.0f);
...
generalPath.lineTo(17.57f, 7.0f);
generalPath.closePath();
shape = generalPath;
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private heading_h1_svgrepo_com() {
    ...
    public static RadianceIcon of(int width, int height) {
       heading_h1_svgrepo_com base = new heading_h1_svgrepo_com();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return heading_h1_svgrepo_com::new;
    }
}
