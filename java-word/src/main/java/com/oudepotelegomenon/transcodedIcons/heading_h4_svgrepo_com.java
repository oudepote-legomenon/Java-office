 ...
 */
public class heading_h4_svgrepo_com implements RadianceIcon {
...
generalPath.lineTo(18.0f, 15.0f);
generalPath.lineTo(13.0f, 15.0f);
generalPath.lineTo(13.0f, 13.0f);
generalPath.lineTo(17.05f, 7.0f);
...
generalPath.lineTo(15.21f, 13.0f);
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private heading_h4_svgrepo_com() {
    ...
    public static RadianceIcon of(int width, int height) {
       heading_h4_svgrepo_com base = new heading_h4_svgrepo_com();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return heading_h4_svgrepo_com::new;
    }
}
